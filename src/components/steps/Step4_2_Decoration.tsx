...
export default function Step4_2_Decoration() {
  ...
  return (
    <div className="w-full">
      <ChefMessage message="Você gostaria de incluir uma decoração gastronômica simples para valorizar a mesa e a apresentação?" />
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <span className="text-sm font-bold text-brand-primary/70">
            Mantemos o foco apenas na experiência gastronômica.
          </span>
        </button>
      </div>
    </div>
